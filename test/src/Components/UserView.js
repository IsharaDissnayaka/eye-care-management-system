...
function UserView(){
 ...
 async function getBlogs() {
     try {
         const res = await axios.get(`http://localhost:8070/blogs`,{ headers });
         setBlogs(res.data);
...
const [filteredBlogs1,filteredBlogs2, filteredBlogs3,filteredBlogs4] = handleSearch();
    ...
    return( 
      <div> <a href={`/adminIT21174780/Post/Post`}>
      <button type="button" class="btn btn-primary m-3" >Back To Dashbord</button>
      </a>
